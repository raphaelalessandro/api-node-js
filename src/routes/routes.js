...
router.patch('/locais-irrigacao', locaisirrigacaoController.editarlocais_irrigacao); 
router.delete('/locais-irrigacao', locaisirrigacaoController.apagarlocais_irrigacao); 
